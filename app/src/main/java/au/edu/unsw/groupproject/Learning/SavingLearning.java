...
import au.edu.unsw.groupproject.Activities.SavingActivity;
...
public class SavingLearning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saving_learning);
        ...
        quizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SavingLearning.this, SavingActivity.class));
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SavingLearning.this, MainActivity.class));
            }
        });
        ...
        awardBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SavingLearning.this, awardsAvailable.class));
            }
        });
        ...
        newsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SavingLearning.this, Temp.class));
            }
        });
        ...
        faqBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SavingLearning.this, QuestionMarkActivity.class));
            }
        });
