...
public class SavingsSet1QuizActivity extends AppCompatActivity {

    String[] question_list = {"What is the definition of interest rate?", "When might a borrower prefer a fixed term’s loan?",
            "Which entity sets the interest rate in Australia"};

    String[] option_list = {"The percentage of income tax", "The fee charged by a bank for opening a savings account", "The cost of borrowing money or the return on investment",
            "The annual salary of an employee",
            "When they want to pay higher interest rate", "When forecasted interest rates are expected to decrease", "When forecasted interest rates are expected to increase", "More than 1 correct answer",
            "RBA", "Commercial banks", "IMF", "The government"};

    String[] answer_list = {"The cost of borrowing money or the return on investment", "When forecasted interest rates are expected to increase",
            "RBA"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savings_set1_quiz);
        ...
        next_button.setOnClickListener(view -> {
            if (isclickBtn) {
                ...
                if (!valueOption.equals(answer_list[currentQuestion])) {
                    Toast.makeText(SavingsSet1QuizActivity.this, "wrong", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(SavingsSet1QuizActivity.this, "correct", Toast.LENGTH_LONG).show();
                ...
                new Handler().postDelayed(() -> {
                    if (currentQuestion != 2) {
                        ...
                        String quizName = "SavingsSet1Quiz";
                        ...
                        Intent intent = new Intent(SavingsSet1QuizActivity.this, PointsActivity.class);
                ...
                Toast.makeText(SavingsSet1QuizActivity.this, "You must at least choose one", Toast.LENGTH_LONG).show();
            }
        });
    }
