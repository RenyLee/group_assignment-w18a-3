...
public class InvestingSet2QuizActivity extends AppCompatActivity {

    String[] question_list = {"What is the difference between digital money and physical money?", "_______ is an example of a pre-paid payment instrument.",
            "What is the pros of using a digital wallet instead of a physical wallet?"};

    String[] option_list = {"Digital money can only be used for online shopping, while physical money can only be  used in physical stores.", "Digital money is intangible, while physical money is tangible. ", "Large transactions cannot be done through digital money",
            "Physical money is subject to lower inflation rates.",
            " Credit card", " Debit card", "Digital wallet", "Gift card",
            "Digital wallets offer higher interest rates for savings.", "Digital wallets do not face any cyber threats and hacking.",
            "Digital wallets remove the need for passwords and PINs.", "Digital wallets provide quick access to funds for transactions"};

    String[] answer_list = {"Digital money is intangible, while physical money is tangible", "Gift card",
            "Digital wallets provide quick access to funds for transactions."};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_investing_set2_quiz);
        ...
        next_button.setOnClickListener(view -> {
            if (isclickBtn) {
                ...
                if (!valueOption.equals(answer_list[currentQuestion])) {
                    Toast.makeText(InvestingSet2QuizActivity.this, "wrong", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(InvestingSet2QuizActivity.this, "correct", Toast.LENGTH_LONG).show();
                ...
                new Handler().postDelayed(() -> {
                    if (currentQuestion != 2) {
                        ...
                        String quizName = "InvestingSet2Quiz";
                        ...
                        Intent intent = new Intent(InvestingSet2QuizActivity.this, PointsActivity.class);
                ...
                Toast.makeText(InvestingSet2QuizActivity.this, "You must at least choose one", Toast.LENGTH_LONG).show();
            }
        });
    }
